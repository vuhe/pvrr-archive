...
fn case_1() {
    ...
    assert_eq!(FilmBaseInfo::from(title), item);
}
...
fn case_42() {
    ...
    let item = FilmBaseInfo {
        title: vec![
            String::from("异世界归来的舅舅"),
            String::from("Isekai Ojisan"),
        ],
        year: None,
        season: None,
        episode: Some(1),
...
fn case_43() {
    ...
    let item = FilmBaseInfo {
        title: vec![
            String::from("夏日重現"),
            String::from("Summer Time Rendering"),
        ],
        year: None,
        season: None,
        episode: Some(15),
